...
const assistantShareImage = "https://o1sf.com/assets/o1sf/tatianasf-assistant-share-card-v2.jpg";
...
export const metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    images: [{ url: assistantShareImage, width: 1280, height: 668, alt: "TatianaSF Assistant — Connect with TatianaSF" }],
  },
};
